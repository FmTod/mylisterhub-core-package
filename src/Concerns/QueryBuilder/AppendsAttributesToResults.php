...
namespace MyListerHub\Core\Concerns\QueryBuilder;
...
trait AppendsAttributesToResults
{
    ...
    public function allowedAppends(mixed $appends): self
    {
    ...
    protected function addAppendsToCursor(LazyCollection $results): LazyCollection
    {
        return $results->each(function (Model $result) {
            return $result->append($this->request->appends()->toArray());
        });
